...
j=f.length;return function(n){if("object"!==typeof n&&"function"!==typeof n||null===n)throw new TypeError("Object.keys called on non-object");var u=[],r;for(r in n)i.call(n,r)&&u.push(r);if(m)for(r=0;r<j;r++)i.call(n,f[r])&&u.push(f[r]);return u}}()})();sigma.classes.Cascade=function(){this.p={};this.config=function(i,m){if("string"==typeof i&&void 0==m)return this.p[i];var f="object"==typeof i&&void 0==m?i:{};"string"==typeof i&&(f[i]=m);for(var j in f)void 0!=this.p[j]&&(this.p[j]=f[j]);return this}};
sigma.classes.EventDispatcher=function(){var i={},m=this;this.one=function(f,j){if(!j||!f)return m;("string"==typeof f?f.split(" "):f).forEach(function(f){i[f]||(i[f]=[]);i[f].push({h:j,one:!0})});return m};this.bind=function(f,j){if(!j||!f)return m;("string"==typeof f?f.split(" "):f).forEach(function(f){i[f]||(i[f]=[]);i[f].push({h:j,one:!1})});return m};this.unbind=function(f,j){f||(i={});var n="string"==typeof f?f.split(" "):f;j?n.forEach(function(f){i[f]&&(i[f]=i[f].filter(function(f){return f.h!=
j}));i[f]&&0==i[f].length&&delete i[f]}):n.forEach(function(f){delete i[f]});return m};this.dispatch=function(f,j){i[f]&&(i[f].forEach(function(i){i.h({type:f,content:j,target:m})}),i[f]=i[f].filter(function(f){return!f.one}));return m}};
(function(){var i;function m(){function b(a){return{x:a.x,y:a.y,size:a.size,degree:a.degree,inDegree:a.inDegree,outDegree:a.outDegree,displayX:a.displayX,displayY:a.displayY,displaySize:a.displaySize,label:a.label,id:a.id,color:a.color,fixed:a.fixed,active:a.active,hidden:a.hidden,forceLabel:a.forceLabel,attr:a.attr}}function l(a){return{source:a.source.id,target:a.target.id,size:a.size,type:a.type,weight:a.weight,displaySize:a.displaySize,label:a.label,hidden:a.hidden,id:a.id,attr:a.attr,color:a.color}}
function g(){d.nodes=[];d.nodesIndex={};d.edges=[];d.edgesIndex={};return d}sigma.classes.Cascade.call(this);sigma.classes.EventDispatcher.call(this);var d=this;this.p={minNodeSize:0,maxNodeSize:0,minEdgeSize:0,maxEdgeSize:0,scalingMode:"inside",nodesPowRatio:0.5,edgesPowRatio:0};this.borders={};g();this.addNode=function(a,b){if(d.nodesIndex[a])throw Error('Node "'+a+'" already exists.');var b=b||{},c={x:0,y:0,size:1,degree:0,inDegree:0,outDegree:0,fixed:!1,active:!1,hidden:!1,forceLabel:!1,label:a.toString(),
id:a.toString(),attr:{}},g;for(g in b)switch(g){case "id":break;case "x":case "y":case "size":c[g]=+b[g];break;case "fixed":case "active":case "hidden":case "forceLabel":c[g]=!!b[g];break;case "color":case "label":c[g]=b[g];break;default:c.attr[g]=b[g]}d.nodes.push(c);d.nodesIndex[a.toString()]=c;return d};this.addEdge=function(a,b,c,g){if(d.edgesIndex[a])throw Error('Edge "'+a+'" already exists.');if(!d.nodesIndex[b])throw Error("Edge's source \""+b+'" does not exist yet.');if(!d.nodesIndex[c])throw Error("Edge's target \""+
c+'" does not exist yet.');g=g||{};b={source:d.nodesIndex[b],target:d.nodesIndex[c],size:1,weight:1,displaySize:0.5,label:a.toString(),id:a.toString(),hidden:!1,attr:{}};b.source.degree++;b.source.outDegree++;b.target.degree++;b.target.inDegree++;for(var o in g)switch(o){case "id":case "source":case "target":break;case "hidden":b[o]=!!g[o];break;case "size":case "weight":b[o]=+g[o];break;case "color":b[o]=g[o].toString();break;case "type":b[o]=g[o].toString();break;case "label":b[o]=g[o];break;default:b.attr[o]=
...
Array?b:b[0]};this.getNodes=function(a){var g=((a instanceof Array?a:[a])||[]).map(function(a){return b(d.nodesIndex[a])});return a instanceof Array?g:g[0]};this.empty=g;this.rescale=function(a,b,c,g){var o=0,h=0;c&&d.nodes.forEach(function(a){h=Math.max(a.size,h)});g&&d.edges.forEach(function(a){o=Math.max(a.size,o)});var h=h||1,o=o||1,l,k,s,p;c&&d.nodes.forEach(function(a){k=Math.max(a.x,k||a.x);l=Math.min(a.x,l||a.x);p=Math.max(a.y,p||a.y);s=Math.min(a.y,s||a.y)});var f="outside"==d.p.scalingMode?
Math.max(a/Math.max(k-l,1),b/Math.max(p-s,1)):Math.min(a/Math.max(k-l,1),b/Math.max(p-s,1)),i=(d.p.maxNodeSize||h)/f;k+=i;l-=i;p+=i;s-=i;var f="outside"==d.p.scalingMode?Math.max(a/Math.max(k-l,1),b/Math.max(p-s,1)):Math.min(a/Math.max(k-l,1),b/Math.max(p-s,1)),j,n;!d.p.maxNodeSize&&!d.p.minNodeSize?(j=1,n=0):d.p.maxNodeSize==d.p.minNodeSize?(j=0,n=d.p.maxNodeSize):(j=(d.p.maxNodeSize-d.p.minNodeSize)/h,n=d.p.minNodeSize);var x,m;!d.p.maxEdgeSize&&!d.p.minEdgeSize?(x=1,m=0):(x=d.p.maxEdgeSize==d.p.minEdgeSize?
0:(d.p.maxEdgeSize-d.p.minEdgeSize)/o,m=d.p.minEdgeSize);c&&d.nodes.forEach(function(c){c.displaySize=c.size*j+n;if(!c.fixed)c.displayX=(c.x-(k+l)/2)*f+a/2,c.displayY=(c.y-(p+s)/2)*f+b/2});g&&d.edges.forEach(function(a){a.displaySize=a.size*x+m});return d};this.translate=function(a,b,c,g,l){var h=Math.pow(c,d.p.nodesPowRatio);g&&d.nodes.forEach(function(d){if(!d.fixed)d.displayX=d.displayX*c+a,d.displayY=d.displayY*c+b;d.displaySize*=h});h=Math.pow(c,d.p.edgesPowRatio);l&&d.edges.forEach(function(a){a.displaySize*=
h});return d};this.setBorders=function(){d.borders={};d.nodes.forEach(function(a){d.borders.minX=Math.min(void 0==d.borders.minX?a.displayX-a.displaySize:d.borders.minX,a.displayX-a.displaySize);d.borders.maxX=Math.max(void 0==d.borders.maxX?a.displayX+a.displaySize:d.borders.maxX,a.displayX+a.displaySize);d.borders.minY=Math.min(void 0==d.borders.minY?a.displayY-a.displaySize:d.borders.minY,a.displayY-a.displaySize);d.borders.maxY=Math.max(void 0==d.borders.maxY?a.displayY-a.displaySize:d.borders.maxY,
a.displayY-a.displaySize)})};this.checkHover=function(a,b){var c,g,l,h=[],f=[];d.nodes.forEach(function(d){if(d.hidden)d.hover=!1;else{c=Math.abs(d.displayX-a);g=Math.abs(d.displayY-b);l=d.displaySize;var s=d.hover,p=c<l&&g<l&&Math.sqrt(c*c+g*g)<l;if(s&&!p)d.hover=!1,f.push(d.id);else if(p&&!s)d.hover=!0,h.push(d.id)}});h.length&&d.dispatch("overnodes",h);f.length&&d.dispatch("outnodes",f);return d}}function f(b,l){function g(){var a;a="<p>GLOBAL :</p>";for(var b in d.p.globalProbes)a+="<p>"+b+" : "+
...
this.activate=function(){if(!d.monitoring)d.monitoring=window.setInterval(g,1E3/d.p.fps);return d};this.desactivate=function(){if(d.monitoring)window.clearInterval(d.monitoring),d.monitoring=null,d.p.dom.innerHTML="";return d}}function j(b){function l(b){if(a.p.mouseEnabled&&(g(a.mouseX,a.mouseY,a.ratio*(0<(void 0!=b.wheelDelta&&b.wheelDelta||void 0!=b.detail&&-b.detail)?a.p.zoomMultiply:1/a.p.zoomMultiply)),a.p.blockScroll))b.preventDefault?b.preventDefault():b.returnValue=!1}function g(b,c,g){if(!a.isMouseDown&&
(window.clearInterval(a.interpolationID),w=void 0!=g,i=a.stageX,j=b,o=a.stageY,k=c,h=g||a.ratio,h=Math.min(Math.max(h,a.p.minRatio),a.p.maxRatio),m=a.p.directZooming?1-(w?a.p.zoomDelta:a.p.dragDelta):0,a.ratio!=h||a.stageX!=j||a.stageY!=k))d(),a.interpolationID=window.setInterval(d,50),a.dispatch("startinterpolate")}function d(){m+=w?a.p.zoomDelta:a.p.dragDelta;m=Math.min(m,1);var b=sigma.easing.quadratic.easeout(m),c=a.ratio;a.ratio=c*(1-b)+h*b;w?(a.stageX=j+(a.stageX-j)*a.ratio/c,a.stageY=k+(a.stageY-
k)*a.ratio/c):(a.stageX=i*(1-b)+j*b,a.stageY=o*(1-b)+k*b);a.dispatch("interpolate");if(1<=m)window.clearInterval(a.interpolationID),b=a.ratio,w?(a.ratio=h,a.stageX=j+(a.stageX-j)*a.ratio/b,a.stageY=k+(a.stageY-k)*a.ratio/b):(a.stageX=j,a.stageY=k),a.dispatch("stopinterpolate")}sigma.classes.Cascade.call(this);sigma.classes.EventDispatcher.call(this);var a=this;this.p={minRatio:1,maxRatio:32,marginRatio:1,zoomDelta:0.1,dragDelta:0.3,zoomMultiply:2,directZooming:!1,blockScroll:!0,inertia:1.1,mouseEnabled:!0};
var f=0,c=0,i=0,o=0,h=1,j=0,k=0,s=0,p=0,C=0,n=0,m=0,w=!1;this.stageY=this.stageX=0;this.ratio=1;this.mouseY=this.mouseX=0;this.isMouseDown=!1;b.addEventListener("DOMMouseScroll",l,!0);b.addEventListener("mousewheel",l,!0);b.addEventListener("mousemove",function(b){a.mouseX=void 0!=b.offsetX&&b.offsetX||void 0!=b.layerX&&b.layerX||void 0!=b.clientX&&b.clientX;a.mouseY=void 0!=b.offsetY&&b.offsetY||void 0!=b.layerY&&b.layerY||void 0!=b.clientY&&b.clientY;if(a.isMouseDown){var d=a.mouseX-f+i,h=a.mouseY-
c+o;if(d!=a.stageX||h!=a.stageY)p=s,n=C,s=d,C=h,a.stageX=d,a.stageY=h,a.dispatch("drag")}a.dispatch("move");b.preventDefault?b.preventDefault():b.returnValue=!1},!0);b.addEventListener("mousedown",function(b){if(a.p.mouseEnabled)a.isMouseDown=!0,a.dispatch("mousedown"),i=a.stageX,o=a.stageY,f=a.mouseX,c=a.mouseY,p=s=a.stageX,n=C=a.stageY,a.dispatch("startdrag"),b.preventDefault?b.preventDefault():b.returnValue=!1},!0);document.addEventListener("mouseup",function(b){if(a.p.mouseEnabled&&a.isMouseDown)a.isMouseDown=
!1,a.dispatch("mouseup"),(i!=a.stageX||o!=a.stageY)&&g(a.stageX+a.p.inertia*(a.stageX-p),a.stageY+a.p.inertia*(a.stageY-n)),b.preventDefault?b.preventDefault():b.returnValue=!1},!0);this.checkBorders=function(){return a};this.interpolate=g}function n(b,l,g,d,a,f,c){function i(a){var b=d,c="fixed"==h.p.labelSize?h.p.defaultLabelSize:h.p.labelSizeRatio*a.displaySize;b.font=(h.p.hoverFontStyle||h.p.fontStyle||"")+" "+c+"px "+(h.p.hoverFont||h.p.font||"");b.fillStyle="node"==h.p.labelHoverBGColor?a.color||
...
c.displaySize/3;k.beginPath();k.moveTo(d,f);k.quadraticCurveTo((d+o)/2+(i-f)/4,(f+i)/2+(d-o)/4,o,i);k.stroke();break;default:k.strokeStyle=j,k.lineWidth=c.displaySize/3,k.beginPath(),k.moveTo(d,f),k.lineTo(o,i),k.stroke()}}return h.currentEdgeIndex<b};this.task_drawNode=function(){for(var c=a.nodes.length,d=0;d++<h.p.nodesSpeed&&h.currentNodeIndex<c;)if(h.isOnScreen(a.nodes[h.currentNodeIndex])){var g=a.nodes[h.currentNodeIndex++],l=Math.round(10*g.displaySize)/10,f=b;f.fillStyle=g.color;f.beginPath();
...
a.displaySize+h.p.borderSize,0,2*Math.PI,!0);b.closePath();b.fill();b.beginPath();b.fillStyle="node"==h.p.nodeActiveColor?a.color||h.p.defaultNodeColor:h.p.defaultNodeActiveColor;b.arc(Math.round(a.displayX),Math.round(a.displayY),a.displaySize,0,2*Math.PI,!0);b.closePath();b.fill();b.fillStyle="node"==h.p.labelActiveColor?a.color||h.p.defaultNodeColor:h.p.defaultLabelActiveColor;b.fillText(a.label,Math.round(a.displayX+1.5*a.displaySize),Math.round(a.displayY+c/2-3));return h};this.drawHoverNode=
i;this.isOnScreen=o;this.resize=function(a,b){j=a;k=b;return h}}function u(b,l){function g(){sigma.chronos.removeTask("node_"+c.id,2).removeTask("edge_"+c.id,2).removeTask("label_"+c.id,2).stopTasks();return c}function d(a,b){c.domElements[a]=document.createElement(b);c.domElements[a].style.position="absolute";c.domElements[a].setAttribute("id","sigma_"+a+"_"+c.id);c.domElements[a].setAttribute("class","sigma_"+a+"_"+b);c.domElements[a].setAttribute("width",c.width+"px");c.domElements[a].setAttribute("height",
c.height+"px");c.domRoot.appendChild(c.domElements[a]);return c}function a(){c.p.drawHoverNodes&&(c.graph.checkHover(c.mousecaptor.mouseX,c.mousecaptor.mouseY),c.graph.nodes.forEach(function(a){a.hover&&!a.active&&c.plotter.drawHoverNode(a)}));return c}function A(){c.p.drawActiveNodes&&c.graph.nodes.forEach(function(a){a.active&&c.plotter.drawActiveNode(a)});return c}sigma.classes.Cascade.call(this);sigma.classes.EventDispatcher.call(this);var c=this;this.id=l.toString();this.p={auto:!0,drawNodes:2,
...
h=i&&(0<=j.indexOf("bottomleft")||0<=j.indexOf("bottom")||0<=j.indexOf("left")),j=i&&(0<=j.indexOf("bottomright")||0<=j.indexOf("bottom")||0<=j.indexOf("right"));b.moveTo(f,g+i);c?b.arcTo(f,g,f+i,g,i):b.lineTo(f,g);m?(b.lineTo(f+d-i,g),b.arcTo(f+d,g,f+d,g+i,i)):b.lineTo(f+d,g);j?(b.lineTo(f+d,g+a-i),b.arcTo(f+d,g+a,f+d-i,g+a,i)):b.lineTo(f+d,g+a);h?(b.lineTo(f+i,g+a),b.arcTo(f,g+a,f,g+a-i,i)):b.lineTo(f,g+a);b.lineTo(f,g+i)};sigma.tools.getRGB=function(b,f){var b=b.toString(),g={r:0,g:0,b:0};if(3<=
b.length&&"#"==b.charAt(0)){var d=b.length-1;6==d?g={r:parseInt(b.charAt(1)+b.charAt(2),16),g:parseInt(b.charAt(3)+b.charAt(4),16),b:parseInt(b.charAt(5)+b.charAt(5),16)}:3==d&&(g={r:parseInt(b.charAt(1)+b.charAt(1),16),g:parseInt(b.charAt(2)+b.charAt(2),16),b:parseInt(b.charAt(3)+b.charAt(3),16)})}f&&(g=[g.r,g.g,g.b]);return g};sigma.tools.rgbToHex=function(b,f,g){return sigma.tools.toHex(b)+sigma.tools.toHex(f)+sigma.tools.toHex(g)};sigma.tools.toHex=function(b){b=parseInt(b,10);if(isNaN(b))return"00";
b=Math.max(0,Math.min(b,255));return"0123456789ABCDEF".charAt((b-b%16)/16)+"0123456789ABCDEF".charAt(b%16)};sigma.publicPrototype=r.prototype})();
